export default {
    ...
    canvas: {
        ...
        plugins: { title: "Node plugins", installedPlugin: "Installed plugin {{name}}", installed: "Installed {{name}}", installFailed: "Installation failed: {{error}}", enabled: "Enabled", disabled: "Disabled", upgradeAvailable: "New version available — click to upgrade", updateFromSource: "Update from source", updated: "Updated", uninstallTitle: "Uninstall this plugin?", uninstall: "Uninstall", newVersion: "A new version is available", officialDescription: "Official plugins from this project's registry", refresh: "Refresh", loadFailed: "Failed to load: {{error}}", loadingOfficial: "Loading official plugins…", noOfficial: "No official plugins", install: "Install", urlPlaceholder: "Enter a plugin JavaScript URL, for example https://.../plugin.js", noThirdParty: "No third-party plugins installed", official: "Official", local: "Local", thirdParty: "Third-party", warning: "Plugin code runs directly on this page and can access browser-local canvas and media data or invoke available AI actions. It cannot read encrypted provider keys. Only install plugins from sources you trust.", aiConfigRequired: "AI configuration is not ready. Configure a model and API key in Settings first.", interactiveTitle: "Interaction mode is active. Click to switch to Move mode and drag the node.", movableTitle: "Move mode is active. Click to switch to Interaction mode and operate the node content.", move: "Move", interact: "Interact" },
    ...
    config: {
        ...
        description: "Secure providers, model selection, and browser-local storage",
        modalDescription: "Provider keys are encrypted by the same-origin backend; canvases and media stay in this browser",
        sessionUnavailable: "Unable to connect to the local API service",
        apiKeyContact: {
        ...
        fileSecurity: "Imports and exports include only local preferences and prompt sources, never providers or API keys.",
        ...
        channels: {
            description: "Each provider uses the OpenAI-compatible protocol. API keys are encrypted by the backend and never enter browser persistence.",
            add: "Add provider",
            ...
            empty: "No providers yet. Add one and configure its models.",
            loading: "Connecting to the configuration service",
        ...
        channelEditor: {
            ...
            modelDescription: "{{count}} selected; assign image or text capability to each model.",
            selectModels: "Select models",
            empty: "Select models to fetch or manually add models.",
            required: "Enter a provider name, HTTPS endpoint, and API key",
            saveFailed: "Failed to save provider",
            httpsOnly: "Only public HTTPS endpoints are allowed. The backend appends /v1 automatically.",
            keepKey: "Leave blank to keep the encrypted key",
            keySecurity: "The key is submitted only over HTTPS and is never stored in or returned to the browser.",
            capabilities: {
                image: "Image",
                text: "Text",
            },
