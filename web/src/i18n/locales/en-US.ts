export default {
    ...
    settingsPanels: {
        ...
        model: { select: "Select model", assign: "Assign a model for {{capability}} in the provider settings", noMatch: "No matching {{capability}} models", addFirst: "Add a provider and models in Settings first", capabilities: { image: "image generation", text: "text", audio: "audio" } },
    },
    ...
    canvas: {
        ...
        configNode: { title: "Generation config", image: "Image", text: "Text", audio: "Audio", prompt: "Prompt", references: "Reference images", audioReferences: "Reference audio", items: "{{count}} items", images: "{{count}} images", compose: "Compose prompt", stop: "Stop", generate: "Generate" },
        projectPage: {
    ...
    config: {
        ...
        localStorage: {
            ...
            stores: { appState: "App state", images: "Image files", media: "Audio files", imageLogs: "Image history", agentMessages: "Agent messages", promptCache: "Prompt cache" },
        },
        promptSources: {
            add: "Add source",
