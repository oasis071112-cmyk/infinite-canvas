...
import { ImageIcon, List, Music2, Settings2, X } from "lucide-react";
...
export function ConnectionCreateMenu({
    ...
    onCreate: (type: CanvasNodeType.Image | CanvasNodeType.Text | CanvasNodeType.Config | CanvasNodeType.Audio) => void;
    onClose: () => void;
}) {
